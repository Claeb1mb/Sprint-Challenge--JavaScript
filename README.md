...
1. Describe the biggest difference between `.forEach` & `.map`.
   The biggest difference in these 2 are that .map returns A new array .foreach changes the original array

2. What is the difference between a function and a method?
   A function is a independent of an object and method is on a object

3) What is closure?
   A closure is when a function reaches outside of its scope to find variables being referenced
...
5. Why do we need super() in an extended class?
   We need super() in extended class to use inheritance features.
